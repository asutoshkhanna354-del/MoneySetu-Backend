    ...
    <AppLayout>
      <div className="space-y-5 pb-6">
        ...
        <motion.div
          ...
          style={{
            background: isDark ? "linear-gradient(135deg, #1a0533, #120025, #0a0a1a)" : "linear-gradient(135deg, #ede8ff, #e8dfff, #f0eaff)",
            backgroundSize: "300% 300%",
            animation: "gradRotate 7s ease infinite",
            border: isDark ? "1px solid rgba(139,92,246,0.25)" : "1px solid rgba(109,40,217,0.18)",
          }}
        >
